                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="alerts_tooltips.php">Alerts &amp; Tooltips</a>
                            </li>
                            <li>
                                <a href="badges_progress.php">Badges &amp; Progress</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="table_basic.php">Basic Tables</a>
                            </li>
                            <li>
                                <a href="datatables.php">Datatables</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="maps_vector.php">Vector maps</a>
                            </li>
                        </ul>
                    </li>
                    <li>
