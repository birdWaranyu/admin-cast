    ...
    <div class="page-content fade-in-up">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Striped rows
                        </div>
                    </div>
                    <div class="ibox-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>02/08/2017</td>
                                <td>
                                    <button class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Edit">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Condensed Table
                        </div>
                    </div>
                    <div class="ibox-body">
