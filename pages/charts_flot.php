...
<!-- START PAGE CONTENT-->
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Flot Charts</li>
        </ol>
    </div>
    <div class="page-content fade-in-up">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Interactivity Chart</div>
                    </div>
                    <div class="ibox-body">
                        <div id="flot_interactivity" style="height:280px;"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Pie Chart</div>
                    </div>
                    <div class="ibox-body">
            ...
            <div class="col-md-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Area Chart</div>
                    </div>
                    <div class="ibox-body">
        ...
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Multiple lines</div>
            </div>
            <div class="ibox-body">
                 <div id="flot_multi_line" style="height:280px;"></div>
            </div>
        </div>
        <div>
