...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Tabs &amp; Accordions
            </li>
        </ol>
    </div>
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <ul class="nav nav-tabs tabs-line">
                           <li class="nav-item">
                               <a class="nav-link active" href="#tab-7-1" data-toggle="tab">
                               	<i class="fa fa-line-chart"></i> First</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#tab-7-2" data-toggle="tab">
                                	<i class="fa fa-heartbeat">
                                	</i> Second</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#tab-7-3" data-toggle="tab">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-7-3">Third tab
                            </div>
                        </div><br>
                    </div>
                </div>
               <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Tabs in Panel
                        </div>
                        <ul class="nav nav-tabs tabs-line pull-right">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#tab-8-2" data-toggle="tab">
                                	<i class="fa fa-bus"></i> Tab</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#tab-8-3" data-toggle="tab">
                                	<i class="fa fa-plane"></i> Tab</a>
                            </li>
                        </ul>
                    </div>
                    <div class="ibox-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-8-3">Third tab
                            </div>
                        </div><br>
                    </div>
                </div>
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Aligned options
                        </div>
                    </div>
                    <div class="ibox-body">
                        <div class="clf">
                            <ul class="nav nav-tabs tabs-line-left">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#tab-9-1" data-toggle="tab">
                                    <i class="fa fa-line-chart"></i> First
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tab-9-2" data-toggle="tab">
                                    <i class="fa fa-heartbeat">
                                    </i> Second
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tab-9-3" data-toggle="tab">
                                    <i class="fa fa-life-ring">
                                    </i> Third</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab-9-2">Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica.
                                </div>
                                <div class="tab-pane fade" id="tab-9-3">Third tab
                                </div>
                            </div>
                    	</div><br>
                        <div class="clf">
                            <ul class="nav nav-tabs tabs-line-right">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#tab-10-2" data-toggle="tab"><i class="fa fa-heartbeat">
                                    </i> Second</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tab-10-3" data-toggle="tab"><i class="fa fa-life-ring">
                                    </i> Third</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab-10-2">Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica.
                                </div>
                                <div class="tab-pane fade" id="tab-10-3">Third tab
                                </div>
                            </div>
                        </div><br>
                        <div class="clf">
                            <ul class="nav nav-tabs tabs-line nav-fill">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#tab-11-3" data-toggle="tab"><i class="fa fa-life-ring">
                                    </i> Third</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab-11-1">Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica.
                                </div>
                                <div class="tab-pane" id="tab-11-2">Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica.
                                </div>
                                <div class="tab-pane fade" id="tab-11-3">Third tab
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="#tab-1-1" data-toggle="tab">
                                	<i class="fa fa-line-chart"></i> First
                                </a>
                            </li>
                            <li class="nav-item">
                                 <a class="nav-link" href="#tab-1-2" data-toggle="tab">
                                 	<i class="fa fa-heartbeat">
                                 	</i> Second
                                 </a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-1-3">Third tab
                            </div>
                ...
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Default pills
                        </div>
                    </div>
                    <div class="ibox-body">
                    ...
                    <div class="wrap-2">
                        ...
                        <div class="color-white" style="margin-left:40px;">
                            ...
                            <ul class="list-unstyled">
                                <li class="m-b-5">
                                	<i class="ti-check m-r-5">
                                	</i>High Quality Design</li>
                                ...
                                <li><i class="ti-check m-r-5">
                                </i>More layouts, pages, components</li>
                            </ul>
                        </div>
                    </div>
                    <div style="flex:1;">
