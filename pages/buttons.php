        ...
        <div class="row btn-list-mrg-5">
            <div class="col-md-6">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <p>Add <code>.btn-lg</code>, <code>.btn-sm
                        </code>, or <code>.btn-xs</code> for additional sizes.</p>
            ...
            <div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <h6 class="m-b-10">Disabled and Active states
                        </h6>
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <div class="btn-group m-b-10">
                            <button class="btn btn-default">Left
                            </button>
                        ...
                        <div class="btn-group m-b-10">
                            ...
                            <div class="btn-group dropdown">
                                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">More <i class="fa fa-angle-down"></i>
                                </button>
                        ...
                        <div class="btn-group m-b-10">
                            <button class="btn btn-default labeled">
                                <span class="btn-label"><i class="fa fa-backward"></i></span>Back
                            </button>
                        ...
                        <div class="btn-toolbar m-b-10">
                            <div class="btn-group">
                                ...
                                <button class="btn btn-default">4
                                </button>
                            </div>
                            <div class="btn-group">
                                <button class="btn btn-default">5
                                </button>
                                <button class="btn btn-default">6
                                </button>
                                <button class="btn btn-default">7
                                </button>
                            </div>
                            <div class="btn-group">
                                <button class="btn btn-default">8
                                </button>
                            </div>
                        </div>
                        <div class="btn-toolbar m-b-10">
                            ...
                            <div class="btn-group">
                                <button class="btn btn-warning">5
                                </button>
                                <button class="btn btn-primary">6
                                </button>
                        ...
                        <div class="btn-group-vertical m-r-10">
                            ...
                            <div class="btn-group dropdown">
                                <button class="btn btn-success dropdown-toggle" data-toggle="dropdown">Fonts <i class="fa fa-angle-down"></i>
                                </button>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="javascript:;">Arial</a>
                        ...
                        <h6 class="m-t-10 m-b-10">Button group sizing
                        </h6>
                        <div class="btn-toolbar m-b-10">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        ...
                        <div class="btn-group">
                            <button class="btn btn-default">Tools
                            </button>
                        ...
                        <div class="btn-group">
                            <button class="btn btn-danger">Tools
                            </button>
                        ...
                        <div class="btn-group dropup">
                            <button class="btn btn-success">Tools
                            </button>
                        ...
                        <div class="btn-group dropup">
                            <button class="btn btn-warning">Tools
                            </button>
