                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <div class="card" style="width:280px;">
                            ...
                            <button class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Add
                            </button>
                            </div>
                        </div><br>
                        <div class="card" style="width:280px;">
                        ...
                        <h5 class="m-t-20 m-b-20">Without image
                        </h5>
                        <div class="card" style="width:280px;">
                            <div class="card-body">
                                <h4 class="card-title">Card title</h4>
                        ...
                        <h5 class="m-b-20">Header & Footer</h5>
                            <div class="card" style="width:320px;">
                                <div class="card-header">
                                    ...
                                    <h6 class="m-0">Becky Brooks</h6><small class="text-muted">16 January 2014</small>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    ...
                                    <a class="link-blue">
                                    	...
                                    	<button class="btn btn-default btn-sm">Share <i class="fa fa-share pull-rightx">
                                    	</i>
                                    	</button>
                                    </div>
                                </div>
                            ...
                            <div class="card" style="width:260px;">
                                ...
                                <div class="card-img-overlay text-white">
                                    <h4 class="card-title">Card title</h4>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <button class="btn btn-default btn-sm">Read
                                    </button>
                                </div>
                            </div><br>
                            <h5 class="m-t-20 m-b-20">With List
                            </h5>
                    	<div class="card" style="width:300px;">
                            <img class="card-img-top" src="assets/img/blog/macarons.jpg" />
                            <div class="card-body">
                                <h4 class="card-title">Jane Smith</h4>
                                <div>Some quick example text.
                                </div>
                            </div>
        ...
        <div>
            <div class="ibox">
                ...
                <div class="ibox-body">
                            ...
                            <div class="card-group">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted card-subtitle">Director
                                        </div>
                                        <div>Some quick example text to build on the card title and make up the bulk of the card's content.</div>
                                    </div>
                                            <div class="card-footer">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted card-subtitle">Designer
                                        </div>
                                        <div>Some quick example text to build on the card title and make up the bulk of the card's content.</div>
                                    </div>
                                    <div class="card-footer">
                        ...
                        <div class="col-md-9">
                            <div class="card-deck">
                                ...
                                <div class="card">
                                    <img class="card-img-top" src="assets/img/image.png" />
                                    <div class="card-body">
                                    <h5 class="card-title">Jack
                                    </h5>
                                        <div class="text-muted card-subtitle">SEO
                                        </div>
                                        <div>Some quick example text to build on the card title and make up the bulk of the card's content.</div>
                                    </div>
                                    <div class="card-footer">
                    ...
                    <h4 class="m-b-20 font-strong">Card columns
                    </h4>
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card-columns">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted card-subtitle">subtitle
                                        </div>
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        <a class="link-blue">
                                        	<i class="fa fa-heart"></i> Like
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h6 class="m-0">Lolla Hatson</h6><small class="text-muted">16 January 2014</small>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        <div class="d-flex justify-content-between align-items-center">
	                                        <a class="link-blue"><i class="fa fa-heart"></i> Like</a>
	                                        <button class="btn btn-default btn-sm">Share <i class="fa fa-share"></i>
	                                        </button>
                                        </div>
                                    </div>
                                </div>
