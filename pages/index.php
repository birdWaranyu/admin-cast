    ...
    <div class="page-content fade-in-up">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="ibox bg-danger color-white widget-stat">
                    <div class="ibox-body">
                        ...
                        <div><i class="fa fa-level-down m-r-5">
                        </i><small>-12% Lower</small></div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="progress-parcent">52%
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar" style="width:37%; height:5px;" aria-valuenow="37" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <ul class="list-group list-group-divider list-group-full tasks-list">
                            <li class="list-group-item task-item">
                                ...
                                <div class="task-actions">
                                    <a href="javascript:;">
                                    	<i class="fa fa-edit text-muted m-r-10"></i>
                                    </a>
                                    <a href="javascript:;">
                            ...
                            <li class="list-group-item task-item">
                                <div>
                                    <label class="ui-checkbox ui-checkbox-gray ui-checkbox-success">
                                        ...
                                        <i class="ti-alarm-clock"></i> 1 hrs</span>
                                </div>
                                <div class="task-data">
                            ...
                            <li class="list-group-item task-item">
                                <div>
                                    <label class="ui-checkbox ui-checkbox-gray ui-checkbox-success">
                                        <input type="checkbox" checked="">
                                        <span class="input-span"></span>
                                        <span class="task-title">Send message to Mick
                                        </span>
                                    </label>
                                </div>
                                <div class="task-data">
                        ...
                        <ul class="media-list media-list-divider m-0">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <div class="media-heading">Jeanne Gonzalez 
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <div class="media-heading">Becky Brooks 
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <div class="media-heading">Frank Cruz 
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <div class="media-heading">Connor Perez 
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Latest Orders
                        </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>$760.00</td>
                                    <td>
                                        <span class="badge badge-default">Pending
                                        </span>
                                    </td>
                                    <td>10/07/2017</td>
                                </tr>
            ...
            <div class="col-lg-4">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Best Sellers
                        </div>
                    </div>
                    <div class="ibox-body">
                        <ul class="media-list media-list-divider m-0">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="font-13">Lorem Ipsum is simply dummy text.
                                    </div>
                                </div>
                            </li>
                            <li class="media">
                    ...
                    <div class="wrap-2">
                        ...
                        <div class="color-white" style="margin-left:40px;">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="m-b-5">
                                	<i class="ti-check m-r-5">	
                                	</i>Fully Customizable and Easy Code
                                </li>
                                <li class="m-b-5">
                                	<i class="ti-check m-r-5">
                                	</i>Bootstrap 4 and Angular 5+
                                </li>
                                <li class="m-b-5">
                                	<i class="ti-check m-r-5">
                                	</i>Best Build Tools: Gulp, SaSS, Pug...
                                </li>
                                <li>
                                	<i class="ti-check m-r-5">	
                                	</i>More layouts, pages, components
                                </li>
                            </ul>
                        </div>
                    </div>
